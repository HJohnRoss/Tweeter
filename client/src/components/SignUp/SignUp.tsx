    ...
    return (
        <div className="logo-box">
            <div className="exit-button">
                <button className="exit" onClick={() => closeSignUp(false)}>X</button>
            </div>
            ...
            <form>
                <button className="bold-text"
                onClick={()=>{
                    setCreateAccount(true)}}>Create account</button>
                    {createAccount && <CreateAccount closeCreateAccount = {setCreateAccount}/>}
            </form>
            <p>
